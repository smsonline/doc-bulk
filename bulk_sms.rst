...
Российские операторы сотовой связи относят знак "@" к локальной unicode кодировке. Если "@" присутствует в тексте сообщения, то  сообщение будет разбито на части по 70 символов. 
